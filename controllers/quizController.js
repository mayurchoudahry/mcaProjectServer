...
exports.generateQuiz = async (req, res) => {
  ...
  let prompt = `Generate 30 ${questionType} questions on the topic of "${topic}". Each question should have 4 options and one correct answer and give the answer key always. Don't generate anything else except question, option, and answer. Generate this type of response: '**1. What is the capital of France?',
  '    1) Paris',
  '    2) London',
  '    3) Rome',
  '    4) Berlin',
